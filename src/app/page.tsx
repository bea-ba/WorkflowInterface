...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      // MOCK: In real app, this would trigger Google OAuth flow
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-primary-50 to-primary-100 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h1 className="text-center text-4xl font-bold text-primary-900 mb-2">
          FinanceFlow
        </h1>
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Turn receipts into insights in seconds
        </p>
      </div>
        ...
        <div className="bg-white py-8 px-4 shadow-xl sm:rounded-lg sm:px-10">
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-md">
            <p className="text-xs text-gray-600 text-center">
              <strong>Demo Mode:</strong> Enter any email/password or use Google sign-in
            </p>
          </div>
        </div>
      </div>
